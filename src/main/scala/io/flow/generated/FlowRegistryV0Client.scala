 ...
 * User agent: apibuilder app.apibuilder.io/flow/registry/latest/ning_1_9_client
 */
package io.flow.registry.v0.models {
  ...
  object HealthcheckDiscriminator {
    ...
    private val byName: Map[String, HealthcheckDiscriminator] = all.map(x => x.toString.toLowerCase -> x).toMap
...
package io.flow.registry.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsRegistryApplication: play.api.libs.json.Reads[io.flow.registry.v0.models.Application] = {
      for {
    ...
    implicit def jsonWritesRegistryApplication: play.api.libs.json.Writes[Application] = {
      (obj: io.flow.registry.v0.models.Application) => {
        io.flow.registry.v0.models.json.jsObjectApplication(obj)
      }
    }

    implicit def jsonReadsRegistryApplicationForm: play.api.libs.json.Reads[io.flow.registry.v0.models.ApplicationForm] = {
      for {
        id <- (__ \ "id").read[String]
    ...
    implicit def jsonWritesRegistryApplicationForm: play.api.libs.json.Writes[ApplicationForm] = {
      (obj: io.flow.registry.v0.models.ApplicationForm) => {
        io.flow.registry.v0.models.json.jsObjectApplicationForm(obj)
      }
    }

    implicit def jsonReadsRegistryApplicationPutForm: play.api.libs.json.Reads[io.flow.registry.v0.models.ApplicationPutForm] = {
      for {
    ...
    implicit def jsonWritesRegistryApplicationPutForm: play.api.libs.json.Writes[ApplicationPutForm] = {
      (obj: io.flow.registry.v0.models.ApplicationPutForm) => {
        io.flow.registry.v0.models.json.jsObjectApplicationPutForm(obj)
      }
    }

    implicit def jsonReadsRegistryApplicationVersion: play.api.libs.json.Reads[io.flow.registry.v0.models.ApplicationVersion] = {
      for {
        id <- (__ \ "id").read[String]
    ...
    def jsObjectApplicationVersion(obj: io.flow.registry.v0.models.ApplicationVersion): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "application" -> io.flow.registry.v0.models.json.jsObjectApplication(obj.application)
      )
    }
    ...
    implicit def jsonWritesRegistryApplicationVersion: play.api.libs.json.Writes[ApplicationVersion] = {
      (obj: io.flow.registry.v0.models.ApplicationVersion) => {
        io.flow.registry.v0.models.json.jsObjectApplicationVersion(obj)
      }
    }

    implicit def jsonReadsRegistryHttp: play.api.libs.json.Reads[io.flow.registry.v0.models.Http] = {
      for {
    ...
    implicit def jsonWritesRegistryHttp: play.api.libs.json.Writes[Http] = {
      (obj: io.flow.registry.v0.models.Http) => {
        io.flow.registry.v0.models.json.jsObjectHttp(obj)
      }
    }

    implicit def jsonReadsRegistryPort: play.api.libs.json.Reads[io.flow.registry.v0.models.Port] = {
      for {
    ...
    def jsObjectPort(obj: io.flow.registry.v0.models.Port): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "service" -> io.flow.registry.v0.models.json.jsObjectServiceReference(obj.service),
    ...
    implicit def jsonWritesRegistryPort: play.api.libs.json.Writes[Port] = {
      (obj: io.flow.registry.v0.models.Port) => {
        io.flow.registry.v0.models.json.jsObjectPort(obj)
      }
    }

    implicit def jsonReadsRegistryPostgresql: play.api.libs.json.Reads[io.flow.registry.v0.models.Postgresql] = {
      for {
    ...
    implicit def jsonWritesRegistryPostgresql: play.api.libs.json.Writes[Postgresql] = {
      (obj: io.flow.registry.v0.models.Postgresql) => {
        io.flow.registry.v0.models.json.jsObjectPostgresql(obj)
      }
    }

    implicit def jsonReadsRegistryService: play.api.libs.json.Reads[io.flow.registry.v0.models.Service] = {
      for {
        id <- (__ \ "id").read[String]
    ...
    implicit def jsonWritesRegistryService: play.api.libs.json.Writes[Service] = {
      (obj: io.flow.registry.v0.models.Service) => {
        io.flow.registry.v0.models.json.jsObjectService(obj)
      }
    }

    implicit def jsonReadsRegistryServiceForm: play.api.libs.json.Reads[io.flow.registry.v0.models.ServiceForm] = {
      for {
        id <- (__ \ "id").read[String]
        defaultPort <- (__ \ "default_port").read[Long]
    ...
    implicit def jsonWritesRegistryServiceForm: play.api.libs.json.Writes[ServiceForm] = {
      (obj: io.flow.registry.v0.models.ServiceForm) => {
        io.flow.registry.v0.models.json.jsObjectServiceForm(obj)
      }
    }

    implicit def jsonReadsRegistryServicePutForm: play.api.libs.json.Reads[io.flow.registry.v0.models.ServicePutForm] = {
      (__ \ "default_port").read[Long].map { x => ServicePutForm(defaultPort = x) }
    }
    ...
    implicit def jsonWritesRegistryServicePutForm: play.api.libs.json.Writes[ServicePutForm] = {
      (obj: io.flow.registry.v0.models.ServicePutForm) => {
        io.flow.registry.v0.models.json.jsObjectServicePutForm(obj)
      }
    }

    implicit def jsonReadsRegistryServiceReference: play.api.libs.json.Reads[io.flow.registry.v0.models.ServiceReference] = {
      (__ \ "id").read[String].map { x => ServiceReference(id = x) }
    }
    ...
    implicit def jsonWritesRegistryServiceReference: play.api.libs.json.Writes[ServiceReference] = {
      (obj: io.flow.registry.v0.models.ServiceReference) => {
        io.flow.registry.v0.models.json.jsObjectServiceReference(obj)
      }
    }

    implicit def jsonReadsRegistryServiceVersion: play.api.libs.json.Reads[io.flow.registry.v0.models.ServiceVersion] = {
      for {
        id <- (__ \ "id").read[String]
        timestamp <- (__ \ "timestamp").read[_root_.org.joda.time.DateTime]
        `type` <- (__ \ "type").read[io.flow.common.v0.models.ChangeType]
    ...
    def jsObjectServiceVersion(obj: io.flow.registry.v0.models.ServiceVersion): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "timestamp" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.timestamp)),
        "type" -> play.api.libs.json.JsString(obj.`type`.toString),
        "service" -> io.flow.registry.v0.models.json.jsObjectService(obj.service)
      )
    }
    ...
    implicit def jsonWritesRegistryServiceVersion: play.api.libs.json.Writes[ServiceVersion] = {
      (obj: io.flow.registry.v0.models.ServiceVersion) => {
        io.flow.registry.v0.models.json.jsObjectServiceVersion(obj)
      }
    }

    implicit def jsonReadsRegistryHealthcheck: play.api.libs.json.Reads[io.flow.registry.v0.models.Healthcheck] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "http" => io.flow.registry.v0.models.json.jsonReadsRegistryHttp.reads(js)
          case "postgresql" => io.flow.registry.v0.models.json.jsonReadsRegistryPostgresql.reads(js)
    ...
    def jsObjectHealthcheck(obj: io.flow.registry.v0.models.Healthcheck): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.registry.v0.models.Http => io.flow.registry.v0.models.json.jsObjectHttp(x)
        case x: io.flow.registry.v0.models.Postgresql => io.flow.registry.v0.models.json.jsObjectPostgresql(x)
        case other => {
    ...
    implicit def jsonWritesRegistryHealthcheck: play.api.libs.json.Writes[Healthcheck] = {
      (obj: io.flow.registry.v0.models.Healthcheck) => {
        io.flow.registry.v0.models.json.jsObjectHealthcheck(obj)
      }
    }
  }
}
...
package io.flow.registry.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/flow/registry/latest/ning_1_9_client"
    val Version = "0.3.41"
    val VersionMajor = 0
