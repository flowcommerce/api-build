 ...
 * apibuilder:0.12.3 https://api.apibuilder.io/flow/registry/0.1.31/ning_1_9_client
 */
      ...
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[Healthcheck] = {
        (js \ "discriminator").validateOpt[String] match {
          ...
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case Some("http") => js.validate[io.flow.registry.v0.models.Http]
              case Some("postgresql") => js.validate[io.flow.registry.v0.models.Postgresql]
              case Some(other) => play.api.libs.json.JsSuccess(io.flow.registry.v0.models.HealthcheckUndefinedType(other))
              case None => sys.error("Union[Healthcheck] requires a discriminator named 'discriminator' - this field was not found in the Json Value")
            }
          }
        }
      }
...
package io.flow.registry.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.3 https://api.apibuilder.io/flow/registry/0.1.31/ning_1_9_client"
    val Version = "0.1.31"
    val VersionMajor = 0
