 ...
 * apidoc:0.11.94 http://www.apidoc.me/bryzek/apidoc-api/0.11.94/ning_1_9_client
 */
...
package com.bryzek.apidoc.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.94 http://www.apidoc.me/bryzek/apidoc-api/0.11.94/ning_1_9_client"
    val Version = "0.11.94"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Applications extends Applications {
      override def get(
        ...
        _executeRequest("GET", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.Application]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.Application]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def post(
        ...
        _executeRequest("POST", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Application", r, _.validate[com.bryzek.apidoc.api.v0.models.Application])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def putByApplicationKey(
        ...
        _executeRequest("PUT", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Application", r, _.validate[com.bryzek.apidoc.api.v0.models.Application])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      ...
      override def deleteByApplicationKey(
        ...
        _executeRequest("DELETE", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 204 => ()
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def postMoveByApplicationKey(
        ...
        _executeRequest("POST", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}/move", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Application", r, _.validate[com.bryzek.apidoc.api.v0.models.Application])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
    ...
    object Attributes extends Attributes {
      override def get(
        ...
        _executeRequest("GET", s"/attributes", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.Attribute]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.Attribute]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getByName(
        ...
        _executeRequest("GET", s"/attributes/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(name, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Attribute", r, _.validate[com.bryzek.apidoc.api.v0.models.Attribute])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def post(
        ...
        _executeRequest("POST", s"/attributes", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 201 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Attribute", r, _.validate[com.bryzek.apidoc.api.v0.models.Attribute])
          case r if r.getStatusCode == 401 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 201, 401, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def deleteByName(
        ...
        _executeRequest("DELETE", s"/attributes/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(name, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 204 => ()
          case r if r.getStatusCode == 401 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204, 401, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
    ...
    object Authentications extends Authentications {
      override def getSessionById(
        ...
        _executeRequest("GET", s"/authentications/session/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(id, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Authentication", r, _.validate[com.bryzek.apidoc.api.v0.models.Authentication])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object Changes extends Changes {
      override def get(
        ...
        _executeRequest("GET", s"/changes", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.Change]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.Change]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
    ...
    object Code extends Code {
      override def get(
        ...
        _executeRequest("GET", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(version, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(generatorKey, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Code", r, _.validate[com.bryzek.apidoc.api.v0.models.Code])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
    ...
    object Domains extends Domains {
      override def post(
        ...
        _executeRequest("POST", s"/domains/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Domain", r, _.validate[com.bryzek.apidoc.api.v0.models.Domain])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def deleteByName(
        ...
        _executeRequest("DELETE", s"/domains/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(name, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 204 => ()
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object EmailVerificationConfirmationForms extends EmailVerificationConfirmationForms {
      override def post(
        ...
        _executeRequest("POST", s"/email_verification_confirmations", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 204 => ()
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
    ...
    object GeneratorServices extends GeneratorServices {
      override def get(
        ...
        _executeRequest("GET", s"/generator_services", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.GeneratorService]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.GeneratorService]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getByGuid(
        ...
        _executeRequest("GET", s"/generator_services/${guid}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.GeneratorService", r, _.validate[com.bryzek.apidoc.api.v0.models.GeneratorService])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def deleteByGuid(
        ...
        _executeRequest("DELETE", s"/generator_services/${guid}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 204 => ()
          case r if r.getStatusCode == 403 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204, 403, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
    ...
    object GeneratorWithServices extends GeneratorWithServices {
      override def get(
        ...
        _executeRequest("GET", s"/generators", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.GeneratorWithService]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.GeneratorWithService]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getByKey(
        ...
        _executeRequest("GET", s"/generators/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(key, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.GeneratorWithService", r, _.validate[com.bryzek.apidoc.api.v0.models.GeneratorWithService])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object Healthchecks extends Healthchecks {
      override def getHealthcheck(
        ...
        _executeRequest("GET", s"/_internal_/healthcheck", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.generator.v0.models.Healthcheck", r, _.validate[com.bryzek.apidoc.generator.v0.models.Healthcheck])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getMigrate(
        ...
        _executeRequest("GET", s"/_internal_/migrate", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Map[String, String]", r, _.validate[Map[String, String]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
    ...
    object Items extends Items {
      override def get(
        ...
        _executeRequest("GET", s"/items", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.Item]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.Item]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getByGuid(
        ...
        _executeRequest("GET", s"/items/${guid}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Item", r, _.validate[com.bryzek.apidoc.api.v0.models.Item])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object MembershipRequests extends MembershipRequests {
      override def get(
        ...
        _executeRequest("GET", s"/membership_requests", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.MembershipRequest]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.MembershipRequest]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def post(
        ...
        _executeRequest("POST", s"/membership_requests", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.MembershipRequest", r, _.validate[com.bryzek.apidoc.api.v0.models.MembershipRequest])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object Memberships extends Memberships {
      override def get(
        ...
        _executeRequest("GET", s"/memberships", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.Membership]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.Membership]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getByGuid(
        ...
        _executeRequest("GET", s"/memberships/${guid}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Membership", r, _.validate[com.bryzek.apidoc.api.v0.models.Membership])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object Organizations extends Organizations {
      override def get(
        ...
        _executeRequest("GET", s"/organizations", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.Organization]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.Organization]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getByKey(
        ...
        _executeRequest("GET", s"/organizations/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(key, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Organization", r, _.validate[com.bryzek.apidoc.api.v0.models.Organization])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def putByKey(
        ...
        _executeRequest("PUT", s"/organizations/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(key, "UTF-8")}", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Organization", r, _.validate[com.bryzek.apidoc.api.v0.models.Organization])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      ...
      override def deleteByKey(
        ...
        _executeRequest("DELETE", s"/organizations/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(key, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 204 => ()
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getAttributesByKey(
        ...
        _executeRequest("GET", s"/organizations/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(key, "UTF-8")}/attributes", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.AttributeValue]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.AttributeValue]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getAttributesByKeyAndName(
        ...
        _executeRequest("GET", s"/organizations/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(key, "UTF-8")}/attributes/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(name, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.AttributeValue", r, _.validate[com.bryzek.apidoc.api.v0.models.AttributeValue])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def putAttributesByKeyAndName(
        ...
        _executeRequest("PUT", s"/organizations/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(key, "UTF-8")}/attributes/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(name, "UTF-8")}", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.AttributeValue", r, _.validate[com.bryzek.apidoc.api.v0.models.AttributeValue])
          case r if r.getStatusCode == 201 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.AttributeValue", r, _.validate[com.bryzek.apidoc.api.v0.models.AttributeValue])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 201, 404, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def deleteAttributesByKeyAndName(
        ...
        _executeRequest("DELETE", s"/organizations/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(key, "UTF-8")}/attributes/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(name, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 204 => ()
          case r if r.getStatusCode == 401 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204, 401, 404", requestUri = Some(r.getUri.toJavaNetURI))
    ...
    object Subscriptions extends Subscriptions {
      override def get(
        ...
        _executeRequest("GET", s"/subscriptions", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.Subscription]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.Subscription]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getByGuid(
        ...
        _executeRequest("GET", s"/subscriptions/${guid}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Subscription", r, _.validate[com.bryzek.apidoc.api.v0.models.Subscription])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def post(
        ...
        _executeRequest("POST", s"/subscriptions", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 201 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Subscription", r, _.validate[com.bryzek.apidoc.api.v0.models.Subscription])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 201, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object Tokens extends Tokens {
      override def getUsersByUserGuid(
        ...
        _executeRequest("GET", s"/tokens/users/${userGuid}", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.Token]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.Token]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getCleartextByGuid(
        ...
        _executeRequest("GET", s"/tokens/${guid}/cleartext", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.CleartextToken", r, _.validate[com.bryzek.apidoc.api.v0.models.CleartextToken])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def post(
        ...
        _executeRequest("POST", s"/tokens", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 201 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Token", r, _.validate[com.bryzek.apidoc.api.v0.models.Token])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 201, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object Users extends Users {
      override def get(
        ...
        _executeRequest("GET", s"/users", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.User]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.User]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getByGuid(
        ...
        _executeRequest("GET", s"/users/${guid}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.User", r, _.validate[com.bryzek.apidoc.api.v0.models.User])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object Validations extends Validations {
      override def post(
        ...
        _executeRequest("POST", s"/validations", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Validation", r, _.validate[com.bryzek.apidoc.api.v0.models.Validation])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
    ...
    object Versions extends Versions {
      override def getByApplicationKey(
        ...
        _executeRequest("GET", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.Version]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.Version]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getByApplicationKeyAndVersion(
        ...
        _executeRequest("GET", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(version, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Version", r, _.validate[com.bryzek.apidoc.api.v0.models.Version])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def postByVersion(
        ...
        _executeRequest("POST", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(version, "UTF-8")}", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Version", r, _.validate[com.bryzek.apidoc.api.v0.models.Version])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      ...
      override def putByApplicationKeyAndVersion(
        ...
        _executeRequest("PUT", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(version, "UTF-8")}", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Version", r, _.validate[com.bryzek.apidoc.api.v0.models.Version])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      ...
      override def deleteByApplicationKeyAndVersion(
        ...
        _executeRequest("DELETE", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(version, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 204 => ()
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getExampleByApplicationKeyAndVersionAndTypeName(
        ...
        _executeRequest("GET", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(version, "UTF-8")}/example/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(typeName, "UTF-8")}", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("_root_.play.api.libs.json.JsObject", r, _.validate[_root_.play.api.libs.json.JsObject])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object Watches extends Watches {
      override def get(
        ...
        _executeRequest("GET", s"/watches", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Seq[com.bryzek.apidoc.api.v0.models.Watch]", r, _.validate[Seq[com.bryzek.apidoc.api.v0.models.Watch]])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getByGuid(
        ...
        _executeRequest("GET", s"/watches/${guid}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Watch", r, _.validate[com.bryzek.apidoc.api.v0.models.Watch])
          case r if r.getStatusCode == 404 => throw new com.bryzek.apidoc.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def getCheck(
        ...
        _executeRequest("GET", s"/watches/check", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("Boolean", r, _.validate[Boolean])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def post(
        ...
        _executeRequest("POST", s"/watches", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 201 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Watch", r, _.validate[com.bryzek.apidoc.api.v0.models.Watch])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 201, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    def parseJson[T](
      ...
      f(play.api.libs.json.Json.parse(r.getResponseBody("UTF-8"))) match {
        ...
        case play.api.libs.json.JsError(errors) => {
          throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Invalid json for class[" + className + "]: " + errors.mkString(" "), requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
