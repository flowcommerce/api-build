 ...
 * apidoc:0.11.52 http://www.apidoc.me/bryzek/apidoc-api/0.11.53/ning_1_9_client
 */
...
package com.bryzek.apidoc.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.52 http://www.apidoc.me/bryzek/apidoc-api/0.11.53/ning_1_9_client"
    val Version = "0.11.53"
    val VersionMajor = 0
    ...
    object PasswordResets extends PasswordResets {
      override def post(
        ...
        _executeRequest("POST", s"/password_resets", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.PasswordResetSuccess", r, _.validate[com.bryzek.apidoc.api.v0.models.PasswordResetSuccess])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
