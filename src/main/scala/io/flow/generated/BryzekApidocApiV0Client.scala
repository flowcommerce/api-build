 ...
 * apidoc:0.10.0 http://www.apidoc.me/bryzek/apidoc-api/0.9.52/ning_1_9_client
 */
...
package com.bryzek.apidoc.api.v0.models {
  ...
  package object json {
    ...
    implicit def jsonWritesApidocapiDiff: play.api.libs.json.Writes[Diff] = new play.api.libs.json.Writes[Diff] {
      def writes(obj: com.bryzek.apidoc.api.v0.models.Diff) = obj match {
    ...
    implicit def jsonWritesApidocapiItemDetail: play.api.libs.json.Writes[ItemDetail] = new play.api.libs.json.Writes[ItemDetail] {
      def writes(obj: com.bryzek.apidoc.api.v0.models.ItemDetail) = obj match {
...
package com.bryzek.apidoc.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.10.0 http://www.apidoc.me/bryzek/apidoc-api/0.9.52/ning_1_9_client"
    val Version = "0.9.52"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Applications extends Applications {
      override def getByOrgKey(
        ...
        _executeRequest("GET", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}", queryParameters = queryParameters).map {
      ...
      override def postByOrgKey(
        ...
        _executeRequest("POST", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}", body = Some(payload)).map {
      ...
      override def putByOrgKeyAndApplicationKey(
        ...
        _executeRequest("PUT", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}", body = Some(payload)).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Application", r, _.validate[com.bryzek.apidoc.api.v0.models.Application])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      ...
      override def deleteByOrgKeyAndApplicationKey(
        ...
        _executeRequest("DELETE", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}").map {
      ...
      override def postMoveByOrgKeyAndApplicationKey(
        ...
        _executeRequest("POST", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}/move", body = Some(payload)).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Application", r, _.validate[com.bryzek.apidoc.api.v0.models.Application])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
    ...
    object Code extends Code {
      override def getByOrgKeyAndApplicationKeyAndVersionAndGeneratorKey(
        ...
        _executeRequest("GET", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(version, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(generatorKey, "UTF-8")}").map {
    ...
    object Domains extends Domains {
      override def postByOrgKey(
        ...
        _executeRequest("POST", s"/domains/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}", body = Some(payload)).map {
      ...
      override def deleteByOrgKeyAndName(
        ...
        _executeRequest("DELETE", s"/domains/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(name, "UTF-8")}").map {
          case r if r.getStatusCode == 204 => ()
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object GeneratorWithServices extends GeneratorWithServices {
      ...
      override def getGeneratorsByKey(
        ...
        _executeRequest("GET", s"/generators/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(key, "UTF-8")}").map {
    ...
    object Organizations extends Organizations {
      ...
      override def getByKey(
        ...
        _executeRequest("GET", s"/organizations/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(key, "UTF-8")}").map {
      ...
      override def putByKey(
        ...
        _executeRequest("PUT", s"/organizations/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(key, "UTF-8")}", body = Some(payload)).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Organization", r, _.validate[com.bryzek.apidoc.api.v0.models.Organization])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      ...
      override def deleteByKey(
        ...
        _executeRequest("DELETE", s"/organizations/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(key, "UTF-8")}").map {
          case r if r.getStatusCode == 204 => ()
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object Versions extends Versions {
      override def getByOrgKeyAndApplicationKey(
        ...
        _executeRequest("GET", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}", queryParameters = queryParameters).map {
      ...
      override def getByOrgKeyAndApplicationKeyAndVersion(
        ...
        _executeRequest("GET", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(version, "UTF-8")}").map {
      ...
      override def postByOrgKeyAndVersion(
        ...
        _executeRequest("POST", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(version, "UTF-8")}", body = Some(payload)).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Version", r, _.validate[com.bryzek.apidoc.api.v0.models.Version])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      ...
      override def putByOrgKeyAndApplicationKeyAndVersion(
        ...
        _executeRequest("PUT", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(version, "UTF-8")}", body = Some(payload)).map {
          case r if r.getStatusCode == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Version", r, _.validate[com.bryzek.apidoc.api.v0.models.Version])
          case r if r.getStatusCode == 409 => throw new com.bryzek.apidoc.api.v0.errors.ErrorsResponse(r)
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      ...
      override def deleteByOrgKeyAndApplicationKeyAndVersion(
        ...
        _executeRequest("DELETE", s"/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(applicationKey, "UTF-8")}/${_root_.com.bryzek.apidoc.api.v0.PathSegment.encode(version, "UTF-8")}").map {
          case r if r.getStatusCode == 204 => ()
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
