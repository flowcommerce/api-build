 ...
 * apibuilder 0.13.0 app.apibuilder.io/apicollective/apibuilder-api/0.13.11/ning_1_9_client
 */
...
package io.apibuilder.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.13.0 app.apibuilder.io/apicollective/apibuilder-api/0.13.11/ning_1_9_client"
    val Version = "0.13.11"
    val VersionMajor = 0
    ...
    object Applications extends Applications {
      ...
      override def deleteByApplicationKey(
        ...
        _executeRequest("DELETE", s"/${_root_.io.apibuilder.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.io.apibuilder.api.v0.PathSegment.encode(applicationKey, "UTF-8")}", requestHeaders = requestHeaders).map {
          ...
          case r => throw io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object Code extends Code {
      override def get(
        ...
        _executeRequest("GET", s"/${_root_.io.apibuilder.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.io.apibuilder.api.v0.PathSegment.encode(applicationKey, "UTF-8")}/${_root_.io.apibuilder.api.v0.PathSegment.encode(version, "UTF-8")}/${_root_.io.apibuilder.api.v0.PathSegment.encode(generatorKey, "UTF-8")}", requestHeaders = requestHeaders).map {
          ...
          case r if r.getStatusCode == 404 => throw io.apibuilder.api.v0.errors.UnitResponse(r.getStatusCode)
          case r if r.getStatusCode == 409 => throw io.apibuilder.api.v0.errors.ErrorsResponse(r)
          case r => throw io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
    ...
    object GeneratorServices extends GeneratorServices {
      ...
      override def deleteByGuid(
        ...
        _executeRequest("DELETE", s"/generator_services/${guid}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 204 => ()
          case r if r.getStatusCode == 403 => throw io.apibuilder.api.v0.errors.UnitResponse(r.getStatusCode)
          case r if r.getStatusCode == 404 => throw io.apibuilder.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204, 403, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
