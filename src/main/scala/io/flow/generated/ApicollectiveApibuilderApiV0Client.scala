 ...
 * apibuilder 0.15.9 app.apibuilder.io/apicollective/apibuilder-api/latest/ning_1_9_client
 */
...
package io.apibuilder.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.9 app.apibuilder.io/apicollective/apibuilder-api/latest/ning_1_9_client"
    val Version = "0.15.4"
    val VersionMajor = 0
