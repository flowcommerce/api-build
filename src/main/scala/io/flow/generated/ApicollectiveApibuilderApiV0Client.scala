 ...
 * Service version: 0.12.14
 * apibuilder:0.12.16 https://app.apibuilder.io/apicollective/apibuilder-api/0.12.14/ning_1_9_client
 */
...
package io.apibuilder.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.16 https://app.apibuilder.io/apicollective/apibuilder-api/0.12.14/ning_1_9_client"
    val Version = "0.12.14"
    val VersionMajor = 0
    ...
    object Applications extends Applications {
      override def get(
        ...
        _executeRequest("GET", s"/${_root_.io.apibuilder.api.v0.PathSegment.encode(orgKey, "UTF-8")}", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          ...
          case r => throw new io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def post(
        ...
        _executeRequest("POST", s"/${_root_.io.apibuilder.api.v0.PathSegment.encode(orgKey, "UTF-8")}", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.getStatusCode == 409 => throw new io.apibuilder.api.v0.errors.ErrorsResponse(r)
          case r => throw new io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def deleteByApplicationKey(
        ...
        _executeRequest("DELETE", s"/${_root_.io.apibuilder.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.io.apibuilder.api.v0.PathSegment.encode(applicationKey, "UTF-8")}", requestHeaders = requestHeaders).map {
          ...
          case r => throw new io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object Attributes extends Attributes {
      ...
      override def getByName(
        ...
        _executeRequest("GET", s"/attributes/${_root_.io.apibuilder.api.v0.PathSegment.encode(name, "UTF-8")}", requestHeaders = requestHeaders).map {
          ...
          case r if r.getStatusCode == 404 => throw new io.apibuilder.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def post(
        ...
        _executeRequest("POST", s"/attributes", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.getStatusCode == 401 => throw new io.apibuilder.api.v0.errors.UnitResponse(r.getStatusCode)
          case r if r.getStatusCode == 409 => throw new io.apibuilder.api.v0.errors.ErrorsResponse(r)
          case r => throw new io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 201, 401, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
      ...
      override def deleteByName(
        ...
        _executeRequest("DELETE", s"/attributes/${_root_.io.apibuilder.api.v0.PathSegment.encode(name, "UTF-8")}", requestHeaders = requestHeaders).map {
          ...
          case r if r.getStatusCode == 401 => throw new io.apibuilder.api.v0.errors.UnitResponse(r.getStatusCode)
          case r if r.getStatusCode == 404 => throw new io.apibuilder.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204, 401, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
    ...
    object Code extends Code {
      override def get(
        ...
        _executeRequest("GET", s"/${_root_.io.apibuilder.api.v0.PathSegment.encode(orgKey, "UTF-8")}/${_root_.io.apibuilder.api.v0.PathSegment.encode(applicationKey, "UTF-8")}/${_root_.io.apibuilder.api.v0.PathSegment.encode(version, "UTF-8")}/${_root_.io.apibuilder.api.v0.PathSegment.encode(generatorKey, "UTF-8")}", requestHeaders = requestHeaders).map {
          ...
          case r if r.getStatusCode == 404 => throw new io.apibuilder.api.v0.errors.UnitResponse(r.getStatusCode)
          case r if r.getStatusCode == 409 => throw new io.apibuilder.api.v0.errors.ErrorsResponse(r)
          case r => throw new io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 404, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
    ...
    object EmailVerificationConfirmationForms extends EmailVerificationConfirmationForms {
      override def post(
        ...
        _executeRequest("POST", s"/email_verification_confirmations", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 204 => ()
          case r if r.getStatusCode == 409 => throw new io.apibuilder.api.v0.errors.ErrorsResponse(r)
          case r => throw new io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
    ...
    object GeneratorServices extends GeneratorServices {
      ...
      override def deleteByGuid(
        ...
        _executeRequest("DELETE", s"/generator_services/${guid}", requestHeaders = requestHeaders).map {
          case r if r.getStatusCode == 204 => ()
          case r if r.getStatusCode == 403 => throw new io.apibuilder.api.v0.errors.UnitResponse(r.getStatusCode)
          case r if r.getStatusCode == 404 => throw new io.apibuilder.api.v0.errors.UnitResponse(r.getStatusCode)
          case r => throw new io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 204, 403, 404", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
    ...
    object Organizations extends Organizations {
      ...
      override def putAttributesByKeyAndName(
        ...
        _executeRequest("PUT", s"/organizations/${_root_.io.apibuilder.api.v0.PathSegment.encode(key, "UTF-8")}/attributes/${_root_.io.apibuilder.api.v0.PathSegment.encode(name, "UTF-8")}", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.getStatusCode == 404 => throw new io.apibuilder.api.v0.errors.UnitResponse(r.getStatusCode)
          case r if r.getStatusCode == 409 => throw new io.apibuilder.api.v0.errors.ErrorsResponse(r)
          case r => throw new io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 200, 201, 404, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    object Subscriptions extends Subscriptions {
      ...
      override def post(
        ...
        _executeRequest("POST", s"/subscriptions", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.getStatusCode == 409 => throw new io.apibuilder.api.v0.errors.ErrorsResponse(r)
          case r => throw new io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Unsupported response code[${r.getStatusCode}]. Expected: 201, 409", requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    ...
    def parseJson[T](
      ...
      f(play.api.libs.json.Json.parse(r.getResponseBody("UTF-8"))) match {
        ...
        case play.api.libs.json.JsError(errors) => {
          throw new io.apibuilder.api.v0.errors.FailedRequest(r.getStatusCode, s"Invalid json for class[" + className + "]: " + errors.mkString(" "), requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
