 ...
 * apidoc:0.9.48 http://www.apidoc.me/bryzek/apidoc-spec/0.9.40-dev/ning_1_9_client
 */
...
package com.bryzek.apidoc.spec.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.9.48 http://www.apidoc.me/bryzek/apidoc-spec/0.9.40-dev/ning_1_9_client"
    ...
    def parseJson[T](
      ...
      f(play.api.libs.json.Json.parse(r.getResponseBody("UTF-8"))) match {
        ...
        case play.api.libs.json.JsError(errors) => {
          throw new com.bryzek.apidoc.spec.v0.errors.FailedRequest(r.getStatusCode, s"Invalid json for class[" + className + "]: " + errors.mkString(" "), requestUri = Some(r.getUri.toJavaNetURI))
        }
      }
    }
