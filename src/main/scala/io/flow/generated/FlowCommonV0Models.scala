 ...
 * apibuilder 0.14.59 app.apibuilder.io/flow/common/0.7.41/play_2_x_standalone_json
 */
package io.flow.common.v0.models {
   ...
   * @param location Indicates the location of the item discount on the order.
   */
  final case class DiscountForm(
    ...
    location: io.flow.common.v0.models.DiscountItemDiscountLocation = io.flow.common.v0.models.DiscountItemDiscountLocation.Order
  )
  ...
  sealed trait DiscountItemDiscountLocation extends _root_.scala.Product with _root_.scala.Serializable

  object DiscountItemDiscountLocation {

    /**
     * Display item discount at the item level.
     */
    case object Item extends DiscountItemDiscountLocation { override def toString = "item" }
    /**
     * Display item discount at the order level.
     */
    case object Order extends DiscountItemDiscountLocation { override def toString = "order" }
     ...
     * with the camel cased values above.
     */
    final case class UNDEFINED(override val toString: String) extends DiscountItemDiscountLocation
     ...
     * above.
     */
    val all: scala.List[DiscountItemDiscountLocation] = scala.List(Item, Order)

    private[this]
    val byName: Map[String, DiscountItemDiscountLocation] = all.map(x => x.toString.toLowerCase -> x).toMap

    def apply(value: String): DiscountItemDiscountLocation = fromString(value).getOrElse(UNDEFINED(value))

    def fromString(value: String): _root_.scala.Option[DiscountItemDiscountLocation] = byName.get(value.toLowerCase)
...
package io.flow.common.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsCommonDiscountItemDiscountLocation = new play.api.libs.json.Reads[io.flow.common.v0.models.DiscountItemDiscountLocation] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[io.flow.common.v0.models.DiscountItemDiscountLocation] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(io.flow.common.v0.models.DiscountItemDiscountLocation(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.common.v0.models.DiscountItemDiscountLocation(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesCommonDiscountItemDiscountLocation(obj: io.flow.common.v0.models.DiscountItemDiscountLocation) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectDiscountItemDiscountLocation(obj: io.flow.common.v0.models.DiscountItemDiscountLocation) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesCommonDiscountItemDiscountLocation: play.api.libs.json.Writes[DiscountItemDiscountLocation] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.DiscountItemDiscountLocation] {
        def writes(obj: io.flow.common.v0.models.DiscountItemDiscountLocation) = {
          jsonWritesCommonDiscountItemDiscountLocation(obj)
        }
      }
    }
    ...
    implicit def jsonReadsCommonDiscountForm: play.api.libs.json.Reads[DiscountForm] = {
      for {
        ...
        location <- (__ \ "location").readWithDefault[io.flow.common.v0.models.DiscountItemDiscountLocation](io.flow.common.v0.models.DiscountItemDiscountLocation.Order)
      } yield DiscountForm(offer, target, label, location)
    }
