 ...
 * Service version: 0.20.86
 * User agent: apibuilder app.apibuilder.io/flow/common/latest/play_2_x_standalone_json
 */
package io.flow.common.v0.models {
   ...
   * @param provinceNumber An optional additional provincial tax registration number for the entity.
   * @param province The province in which the provincial registration number is defined.
   */

  final case class MerchantOfRecordEntityRegistration(
    number: String,
    country: String,
    provinceNumber: _root_.scala.Option[String] = None,
    province: _root_.scala.Option[String] = None
  )
  ...
  package object json {
    ...
    implicit def jsonReadsCommonMerchantOfRecordEntityRegistration: play.api.libs.json.Reads[io.flow.common.v0.models.MerchantOfRecordEntityRegistration] = {
      for {
        number <- (__ \ "number").read[String]
        country <- (__ \ "country").read[String]
        provinceNumber <- (__ \ "province_number").readNullable[String]
        province <- (__ \ "province").readNullable[String]
      } yield MerchantOfRecordEntityRegistration(number, country, provinceNumber, province)
    }
    ...
    def jsObjectMerchantOfRecordEntityRegistration(obj: io.flow.common.v0.models.MerchantOfRecordEntityRegistration): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "number" -> play.api.libs.json.JsString(obj.number),
        "country" -> play.api.libs.json.JsString(obj.country)
      ) ++ (obj.provinceNumber match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("province_number" -> play.api.libs.json.JsString(x))
      }) ++
      (obj.province match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("province" -> play.api.libs.json.JsString(x))
